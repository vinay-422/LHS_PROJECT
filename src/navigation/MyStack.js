...
import { Alerts, Home, Sidebar, CompleteKyc, Attendence, Visit, MyBeatPlan, StoreDetail ,AddStore, Add_editProduct} from '../screens';
...
export default function MyStack() {
  return (
    ...
    >
      ...
      <Stack.Screen name='MyBeatPlan' component={MyBeatPlan} />
